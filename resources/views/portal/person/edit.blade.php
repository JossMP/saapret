...
<section class="w-full px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64">
    <div class="w-full relative mt-1 shadow-2xl rounded overflow-hidden">
        ...
        <div class="grid justify-items-center bg-white">
            <div class="col-span-12 h-full pb-12 md:col-span-9">

                <form action="{{ route('portal.person.update',$person) }}" method="POST" class="px-4 pt-4"
                    ...
                    <div class="bg-white shadow-md rounded pt-6 pb-8 mb-4 my-3">
                        ...
                        'district_id' => $person->district_home->id,
                        'name' => 'home',
                        ])
                        ...
                        'district_id' => $person->district_birth->id,
                        'name' => 'birth',
                        ])
                        ...
                        <div class="grid sm:grid-cols-2 gap-4 mx-4 pb-4">
                            <div class="col-span-2 sm:col-span-1">
                                ...
                                <input
                                    ...
                                    id="phone" name="phone" type="text" placeholder="Telefono"
                                    value="{{ $person->phone }}">
                                @error('phone')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                @enderror
