...
<div class="card">
    <div class="card-header">
        <h5 class="card-title">Datos de Nuevo Usuario</h5>
        <div class="card-tools">
        </div>
    </div>

    <div class="card-body">
        <form class="form" action="{{route('panel.users.store')}}" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-3">
                    <div class="text-center">
                        <img src="{{asset('images/avatars/default.png')}}" class="avatar img-circle img-thumbnail"
                ...
                <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('username') is-invalid @enderror" name="username"
                            id="username" placeholder="Usuario" title="Usuario" value="{{old("username")}}" required>
                        @error('username')
                        <small class="text-bold invalid-feedback m-0">
                            {{ $message }}
                        </small>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control @error('password') is-invalid @enderror"
                                    ...
                                    title="{{__('Password')}}" value="" required>
                                @error('password')
                                <small class="text-bold invalid-feedback m-0">
                                    {{ $message }}
                                </small>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="password_confirmation"
                                    ...
                                    title="{{__('Confirm Password')}}" value="" required>
